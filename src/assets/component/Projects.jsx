...
function Projects() {
  return (
    <section id='projects' className='h-full relative flex flex-col  justify-center lg:justify-start items-center w-full mt-20'>
       <div className="">
            <div className="flex flex-col justify-center items-center mb-10">
                <h1 className='text-[76px] font-cairo font-semibold mb-4'>LEATEST PROJECTS</h1>
